...
public:
    ...
    void approx_closure(std::vector<GraphData> &vector, ClosureParameters &parameters, std::vector<int> &approximation,
                        double& closure_time, ClosureFunction closure = nullptr);
    void approx_closure(std::vector<OuterplanarGraphData> &vector, ClosureParameters &parameters, std::vector<int> &approximation,
                        double& closure_time, ClosureFunction closure = nullptr);
