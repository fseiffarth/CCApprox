...
void GraphClosureSP::approx_closure(std::vector<GraphData> &samples, ClosureParameters &closureParameters,
                                    std::vector<int> &approximation,  double& closure_time, ClosureFunction closureFunction) {
...
void GraphClosureSP::approx_closure(std::vector<OuterplanarGraphData> &samples, ClosureParameters &closureParameters,
                                    std::vector<int> &approximation,  double& closure_time, ClosureFunction closureFunction) {
    std::fill(approximation.begin(), approximation.end(), 0);
    for (auto & sample : samples) {
        auto start_closure = std::chrono::high_resolution_clock::now();
